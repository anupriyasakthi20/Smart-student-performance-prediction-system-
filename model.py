...
def save_to_excel(
    ...
    try:
        ...
        messagebox.showerror(
            "Excel Save Error",
            f"Could not save data to Excel.\n\n{error}"
        )
...
def predict_performance():
    ...
    try:
        ...
        # ====================================================
        # Internal marks are out of 30.
        # Convert them to percentage for calculation.
        ...
        prediction_result.config(
            text=f"Predicted Performance: {performance}",
            foreground="#CC3982"
        )
        ...
        if saved:
            ...
            messagebox.showinfo(
                "Saved Successfully",
                "Student prediction has been saved successfully!\n\n"
